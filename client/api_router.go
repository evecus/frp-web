...
import (
	...
	"github.com/fatedier/frp/client/panel"
...
func (svr *Service) registerRouteHandlers(helper *httppkg.RouterRegisterHelper) {
	...
	// Mounted at /panel/ with its own session-based auth (independent of frpc Basic Auth).
	// Access: http://<webServer.addr>:<webServer.port>/panel/
	panelH := panel.NewHandler(svr)
	panelSub := helper.Router.PathPrefix("/panel").Subrouter()
	panelH.Register(panelSub)
	helper.Router.HandleFunc("/panel", func(w http.ResponseWriter, r *http.Request) {
